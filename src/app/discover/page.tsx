...
export default function DiscoverPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      window.location.href = `mailto:zev330@gmail.com?subject=${subject}&body=${body}`;
      setSubmitted(true);
    } finally {
      setSubmitting(false);
            ...
            >
              ...
              {step === 0 && (
                <div className="text-center md:text-left">
                  ...
                  >
                    A few questions to help me understand your business and make
                    our conversation as productive as possible. Takes about 5 minutes.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
              ...
              {step === THANK_YOU_STEP && (
                <div className="text-center md:text-left">
                  ...
                  >
                    I&apos;ll review everything before we meet. Looking forward to
                    our conversation.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0 }}
