        ...
        <div className="mx-auto max-w-[1280px] px-6 md:px-12">
          ...
          >
            ...
            <p className="mt-8 text-lg text-muted-light max-w-2xl leading-relaxed">
              Three levels of engagement — from a focused assessment to an
              ongoing AI partnership. Every engagement delivers real, deployed
              systems.
            </p>
          </motion.div>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                ...
                <div className="lg:col-span-7">
                  ...
                  <div className="mt-10">
                    ...
                    >
                      {i === 0 ? 'Book a discovery call' : i === 1 ? 'Tell us about your project' : 'Learn more'}
