...
const STATS = [
  ...
  { value: 23, suffix: '', label: 'Tree of Life Paths' },
...
const ASPECTS = [
  ...
  },
  {
    ...
    body: "The Prism agent runs a 4-pass spiral test on every deliverable: smoke, feature, edge case, regression. The Guardian enforces brand and quality constraints adversarially. Nothing ships until both agents sign off. The human reviews results, not bugs.",
...
const TECH = [
  ...
  'Supabase', 'PostgreSQL', 'Framer Motion', 'React Flow',
        ...
        <div className="mx-auto max-w-[1280px] px-6 md:px-12">
          ...
          >
            ...
            <p className="mt-8 text-lg text-muted-light max-w-2xl leading-relaxed">
              ...
              The framework isn&apos;t theoretical — it&apos;s running right now.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1280px] px-6 md:px-12 py-32 md:py-40">
          <Reveal>
            ...
            <p className="text-lg text-muted-light max-w-[640px] leading-relaxed">
              11 specialized agents. 9 sacred geometry engines. A complete
              design system, 7 public pages, a real-time admin dashboard, and
              persistent runtime agents — all orchestrated through the Tree of
              Life Architecture.
            </p>
          </Reveal>
        </div>
              ...
              <Reveal>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                  <div className="lg:col-span-3 flex items-center gap-4">
                    {GeometryIcon && (
                      <GeometryIcon size={32} color="var(--color-accent)" animate />
                    )}
              ...
              {[
                ...
                <StaggerChild key={p.phase}>
                  <div className="border border-border rounded-xl p-6 h-full">
                    <span className="text-3xl font-[family-name:var(--font-serif)] font-light text-border leading-none select-none">
                      {p.phase}
                    </span>
