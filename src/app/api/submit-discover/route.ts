          ...
          await resend.emails.send({
            ...
            text: isPaid
              ? [
                  `Hi ${firstName},`,
                  '',
                  `Thank you for your purchase. Your personalized AI Insight Report for ${body.company || 'your business'} is now being prepared.`,
                  '',
                  `Here's what's happening right now:`,
                  `- Our research agent is analyzing your business and industry`,
                  `- Our architecture agent is mapping AI opportunities to your specific situation`,
                  `- Our synthesis agent is preparing your personalized insight report`,
                  '',
