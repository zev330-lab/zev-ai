      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="text-2xl font-bold font-[family-name:var(--font-display)]">
              <span className="text-foreground">zev</span>
              <span className="gradient-text">.ai</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm text-muted leading-relaxed">
              AI implementation consulting for businesses ready to transform their operations.
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a
                href="https://github.com/zev330-lab"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted hover:text-accent transition-colors"
                aria-label="GitHub"
        ...
        <div className="mt-16 pt-8 border-t border-surface-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted">
            © {new Date().getFullYear()} Zev Steinmetz. All rights reserved.
          </p>
